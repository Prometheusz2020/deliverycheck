...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      <body>
        <div className="min-h-screen relative p-1 sm:p-4 md:p-8 flex flex-col items-center">
          ...
          <footer className="mt-auto py-4 text-center text-text-3 text-[10px] uppercase tracking-[0.2em] opacity-40">
